...
[![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC%20BY--NC%204.0-4e8c65.svg)](https://creativecommons.org/licenses/by-nc/4.0/)
...
[CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/) — free to use and adapt with credit, not for commercial use without permission.
